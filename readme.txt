...
= How many parents can a user have? =

A seemingly unlimited number, though you probably don't really want to test this theory.

= Where can I get support? =

The WordPress support forums: https://wordpress.org/support/plugin/wp-user-parents.

= Where can I find documentation? =

http://github.com/stuttter/wp-user-parents
